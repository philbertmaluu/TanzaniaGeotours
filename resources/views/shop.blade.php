                        ...
                        <div class="geodir-post-slider center-gallery">
                            <div class="bxslider">
                                @foreach($shop->photos as $photo)
                                    @php
                                        // Replace 'localhost' with '127.0.0.1:8001' in photo URL if necessary
                                        $photoUrl = Str::replaceFirst('localhost', '127.0.0.1:8001', $photo->url);
                                    @endphp
                                                        ...
                                                        @foreach($shop->photos as $photo)
                                                                <li>
                                                                    @php
                                                                        ...
                                                                        if (Str::contains($photoUrl, 'localhost')) {
                                                                            $photoUrl = Str::replaceFirst('localhost', '127.0.0.1:8001', $photoUrl);
                                                                        }
                                                                        if (Str::contains($thumbUrl, 'localhost')) {
                                                                            $thumbUrl = Str::replaceFirst('localhost', '127.0.0.1:8001', $thumbUrl);
                                                                        }
                                                                    @endphp
